...
To change the orientation of the axis and grid lines to the y-axis, we can provide the `plot_direction = 'vert'` argument. The default is 'horiz' for horizontal (x-axis and horizontal grid lines shown).

```{r}
gg_ex_bar +
  theme_capd(plot_direction = 'vert')
...
### Axis line orientation: `plot direction`
...
## default: 'horiz'
gg_ex_bar +
  theme_capd(plot_direction = 'horiz')

gg_ex_bar +
  theme_capd(plot_direction = 'vert')

gg_ex_bar +
  theme_capd(plot_direction = 'both')
...
Note that this interacts with the `plot_direction` argument and only shows the gridlines for the orientations specified. Other gridlines remain hidden.

```{r}
gg_ex_bar +
  theme_capd(grid_lines = 'major', plot_direction = 'horiz')

gg_ex_bar +
  theme_capd(grid_lines = 'major', plot_direction = 'vert')

gg_ex_bar +
  theme_capd(grid_lines = c('major','minor'), plot_direction = 'vert')
...
The `ticks` argument determines whether to show (TRUE) or hide (FALSE) the tick marks on the non-major axis, or the one perpendicular to the plot's orientation. For vertical `plot_directions`, this is the y-axis ticks marks and for horizontal orientations, this is the x-axis tick marks.
...
When `plot_direction = 'both'`, this controls whether to show both x-axis and y-axis tick marks.

```{r}
gg_ex_bar +
  theme_capd(ticks = TRUE, plot_direction = 'both')
```
